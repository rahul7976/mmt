Rails.application.configure do
  ...
  config.action_controller.default_url_options = { host: 'https://draftmmt.sit.earthdata.nasa.gov' }

  # Enable serving of images, stylesheets, and JavaScripts from an asset server.
  config.action_controller.asset_host = 'https://draftmmt.sit.earthdata.nasa.gov'

  # Ignore bad email addresses and do not raise email delivery errors.
  # Set this to true and configure the email server for immediate delivery to raise delivery errors.
  # config.action_mailer.raise_delivery_errors = false
  config.action_mailer.default_url_options = { host: 'draftmmt.sit.earthdata.nasa.gov', protocol: 'https' }
  ...
  Rails.application.routes.default_url_options[:host] = 'https://draftmmt.sit.earthdata.nasa.gov'
